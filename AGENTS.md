# One-Sitting Idle: incremental games designed to end in 30–60 minutes, with a story and no ads (`one-sitting-idle`) — factory product contract

This repository is one product built by the Param Factory. It ships at
`https://one-sitting-idle.sociobot.in`. Artifact class: `static-web`.
